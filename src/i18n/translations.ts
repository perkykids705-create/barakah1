...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    signIn: 'Sign In',
    signUp: 'Sign Up',
    completeOnboardingBtn: 'Bismillah — Begin My Journey',
  ...
  ar: {
    ...
    completeOnboardingBtn: 'بسم الله — ابدأ رحلتك الإيمانية',
  ...
  ur: {
    ...
    completeOnboardingBtn: 'بسم اللہ — بابرکت آغاز کریں',
  ...
  hi: {
    ...
    completeOnboardingBtn: 'बिस्मिल्लाह — अपनी बरकत यात्रा शुरू करें',
  ...
  bn: {
    ...
    completeOnboardingBtn: 'বিসমিল্লাহ — বরকতময় যাত্রা শুরু করুন',
