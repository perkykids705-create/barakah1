...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    prayerViaAladhan: 'Precise location-based prayer timing',
    ...
    nafl: 'Mustahabb / Nafl (Voluntary)',
    mubah: 'Mubah (Daily Life Task)',
    lifeCategoryLabel: 'Life Category & Sphere',
    allCategories: 'All Categories',
    catWorship: 'Worship & Deen',
    catQuran: 'Qur\'an & Knowledge',
    catWork: 'Work & Career',
    catFamily: 'Family & Household',
    catHealth: 'Health & Vitality',
    catCharity: 'Charity & Khidmah',
    catFinance: 'Halal Business & Finance',
    catPersonal: 'Personal Growth & Errands',
    filterByLifeCategory: 'Filter by Category:',
    noTasksInLifeCategory: 'No Tasks Found in this Category',
    noTasksInLifeCategoryDesc: 'No tasks scheduled under this sphere yet. Add a prayer-anchored task or switch back to all categories.',
    showAllCategoriesBtn: 'Show All Categories',
    addCategoryTaskBtn: 'Add Task to Category',
    completedTaskLocked: 'Completed Task Protected',
    completedTaskWarning: 'This task was already logged as completed in your database and spiritual ledger. Modifying or reopening it requires confirmation to ensure consistency.',
    editTask: 'Edit Task',
  ...
  ar: {
    ...
    islamicPriorities: 'مراتب الأعمال والأولويات الإسلامية',
    fardh: 'فرض (واجب قطعي)',
    wajib: 'واجب',
    sunnah: 'سنة مؤكدة',
    nafl: 'مستحب / نفل',
    mubah: 'مباح (شؤون الحياة اليومية)',
    lifeCategoryLabel: 'مجال ومحور المهمة',
    allCategories: 'جميع المجالات',
    catWorship: 'العبادة والذكر',
    catQuran: 'القرآن وطلب العلم',
    catWork: 'العمل والمهنة',
    catFamily: 'الأسرة والبيت',
    catHealth: 'الصحة والنشاط',
    catCharity: 'الصدقة وخدمة الناس',
    catFinance: 'التجارة والمال الحلال',
    catPersonal: 'التطوير الشخصي والمهام',
    completedTaskLocked: 'مهمة مكتملة ومحمية',
    completedTaskWarning: 'تم تسجيل هذه المهمة كمكتملة في سجلك وسجل الإنجازات. تعديلها أو إعادة فتحها يتطلب تأكيداً لضمان ثبات البيانات.',
    editTask: 'تعديل المهمة',
    reopenTask: 'إعادة فتح المهمة',
    keepCompleted: 'الإبقاء عليها مكتملة',
  ...
  ur: {
    ...
    islamicPriorities: 'اسلامی ترجیحات اور زمرہ جات',
    fardh: 'فرض (لازمی)',
    wajib: 'واجب',
    sunnah: 'سنتِ مؤکدہ',
    nafl: 'مستحب / نفل',
    mubah: 'مباح (روزمرہ دنیاوی امور)',
    lifeCategoryLabel: 'زندگی کا زمرہ و شعبہ',
    allCategories: 'تمام شعبہ جات',
    catWorship: 'عبادت و ذکر',
    catQuran: 'قرآن و دینی علم',
    catWork: 'ملازمت و کاروبار',
    catFamily: 'گھر اور اہل و عیال',
    catHealth: 'صحت و ورزش',
    catCharity: 'صدقہ و خدمتِ خلق',
    catFinance: 'حلال کمائی و مالیات',
    catPersonal: 'ذاتی ترقی و روزمرہ کام',
    completedTaskLocked: 'مکمل شدہ ٹاسک محفوظ ہے',
    completedTaskWarning: 'یہ ٹاسک آپ کے روحانی ریکارڈ میں مکمل درج ہو چکا ہے۔ ڈیٹا کی درستگی کے لیے دوبارہ کھولنے یا ترمیم کے لیے تصدیق درکار ہے۔',
    editTask: 'ٹاسک میں ترمیم کریں',
    reopenTask: 'ٹاسک دوبارہ کھولیں',
    keepCompleted: 'مکمل رہنے دیں',
    markAsDone: 'مکمل نشان زد کریں',
    completedAt: 'مکمل ہوا بتاریخ',
  ...
  hi: {
    ...
    prayerViaAladhan: 'सटीक स्थान-आधारित नमाज़ का समय',
    ...
    islamicPriorities: 'इस्लामी प्राथमिकताएँ व श्रेणियाँ',
    fardh: 'फ़र्ज़ (अनिवार्य)',
    wajib: 'वाजिब (ज़रूरी)',
    sunnah: 'सुन्नत मुअक्कदा',
    nafl: 'मुस्तहब / नफ़्ल (ऐच्छिक)',
    mubah: 'मुबाह (दैनिक जीवन के कार्य)',
    lifeCategoryLabel: 'दैनिक जीवन श्रेणी',
    allCategories: 'सभी श्रेणियाँ',
    catWorship: 'इबादत व ज़िक्र',
    catQuran: 'क़ुरआन व तालीम',
    catWork: 'काम व आजीविका',
    catFamily: 'परिवार व घर',
    catHealth: 'स्वास्थ्य व तंदुरुस्ती',
    catCharity: 'सदक़ा व सेवा',
    catFinance: 'हलाल वित्त व व्यवसाय',
    catPersonal: 'व्यक्तिगत विकास',
    completedTaskLocked: 'पूर्ण कार्य सुरक्षित',
    completedTaskWarning: 'यह कार्य आपके रिकॉर्ड में पूर्ण दर्ज हो चुका है। डेटा की स्थिरता बनाए रखने के लिए इसमें बदलाव हेतु पुष्टि आवश्यक है।',
    editTask: 'कार्य संपादित करें',
    reopenTask: 'कार्य पुनः खोलें',
    keepCompleted: 'पूर्ण ही रखें',
    markAsDone: 'पूर्ण चिह्नित करें',
    completedAt: 'पूर्ण होने का समय',
    habitsTitle: 'आदत ट्रैकर',
    weeklyReview: 'साप्ताहिक व मासिक समीक्षा',
    addTask: 'नमाज़-आधारित कार्य जोड़ें',
  ...
  bn: {
    ...
    prayerViaAladhan: 'নির্ভুল অবস্থানভিত্তিক নামাজের সময়',
    ...
    islamicPriorities: 'ইসলামি অগ্রাধিকার ও দৈনন্দিন ট্যাগ',
    fardh: 'ফরজ (আবশ্যকীয়)',
    wajib: 'ওয়াজিব',
    sunnah: 'সুন্নাতে মুয়াক্কাদাহ',
    nafl: 'মুস্তাহাব / নফল',
    mubah: 'মুয়াহ / সাধারণ কাজ',
    lifeCategoryLabel: 'জীবনের ক্ষেত্র ও ক্যাটাগরি',
    allCategories: 'সকল ক্যাটাগরি',
    catWorship: 'ইবাদত ও জিকির',
    catQuran: 'কোরআন ও দ্বীনি শিক্ষা',
    catWork: 'চাকরি ও পেশা',
    catFamily: 'পরিবার ও সংসার',
    catHealth: 'স্বাস্থ্য ও সুস্থতা',
    catCharity: 'সাদাকাহ ও খেদমত',
    catFinance: 'হালাল ব্যবসা ও অর্থ',
    catPersonal: 'ব্যক্তিগত উন্নয়ন ও কাজ',
    completedTaskLocked: 'সম্পন্ন কাজ সুরক্ষিত',
    completedTaskWarning: 'এই কাজটি আপনার ডাটাবেজে সম্পন্ন হিসেবে সংরক্ষিত হয়েছে। তথ্যের ধারাবাহিকতা রক্ষায় এটি পুনরায় উন্মুক্ত করতে অনুমোদনের প্রয়োজন।',
    editTask: 'কাজ সম্পাদনা করুন',
    reopenTask: 'কাজ পুনরায় খুলুন',
    keepCompleted: 'সম্পন্ন রাখুন',
